...
public class ResponseGetBankPositionDashboard extends BaseDTO implements Serializable {
	private static final long serialVersionUID = 1L;

	@JsonProperty("bankPositionDashboard")
	private BankPositionDashboardDTO data;
	...
	public BankPositionDashboardDTO getData() {
		return data;
	}

	public void setData(BankPositionDashboardDTO data) {
		this.data = data;
	} 		
}
