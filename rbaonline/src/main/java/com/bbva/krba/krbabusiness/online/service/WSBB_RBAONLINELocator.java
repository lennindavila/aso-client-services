...
public class WSBB_RBAONLINELocator extends org.apache.axis.client.Service implements com.bbva.krba.krbabusiness.online.service.WSBB_RBAONLINE {
    ...
    private java.lang.String OnlineServiceImplPort_address = "http://150.250.233.11:31501/krba_mult_web_krbafront_01/services/WSBB_RBAONLINE";

    public java.lang.String getOnlineServiceImplPortAddress() {
        return OnlineServiceImplPort_address;
    }
    
    public void setOnlineServiceImplPortAddress(java.lang.String OnlineServiceImplPort_address) {
        this.OnlineServiceImplPort_address = OnlineServiceImplPort_address;
    }     
    ...
    public com.bbva.krba.krbabusiness.online.service.OnlineService getOnlineServiceImplPort() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
            endpoint = new java.net.URL(OnlineServiceImplPort_address);
        }
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bbva.krba.krbabusiness.online.service.OnlineService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bbva.krba.krbabusiness.online.service.WSBB_RBAONLINESoapBindingStub _stub = new com.bbva.krba.krbabusiness.online.service.WSBB_RBAONLINESoapBindingStub(new java.net.URL(OnlineServiceImplPort_address), this);
                _stub.setPortName(getOnlineServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
