...
import pe.bbva.aso.servicios.getcustomerterm.config.GetCustomerTermASOConfig;
import pe.bbva.aso.servicios.getcustomerterm.dto.CustomerTermDTO;
...
public class TestGetCustomerTermASOConfig {
	...
	public void consultar() {
		...
		try {
			response = obj.getCustomerTerm(filtro, tsec);
			if(response!=null) {
