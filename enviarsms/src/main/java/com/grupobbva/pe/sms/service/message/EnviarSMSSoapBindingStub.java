...
public class EnviarSMSSoapBindingStub extends org.apache.axis.client.Stub implements com.grupobbva.pe.sms.service.message.EnviarSMS {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "operador"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setNillable(true);
        oper.addParameter(param);
    ...
    public EnviarSMSSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public EnviarSMSSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public EnviarSMSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String enviar(java.lang.String numeroOperacion, java.lang.String mensaje, java.lang.String telefono, java.lang.String operador) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://sms.pe.grupobbva.com", "enviar"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {numeroOperacion, mensaje, telefono, operador});
