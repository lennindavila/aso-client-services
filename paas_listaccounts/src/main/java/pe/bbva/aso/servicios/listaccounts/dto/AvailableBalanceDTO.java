...
public class AvailableBalanceDTO implements Serializable {
	...
	private List<PostedBalancesDTO> postedBalances;
	...
	public List<PostedBalancesDTO> getPostedBalances() {
		return postedBalances;
	}

	public void setPostedBalances(List<PostedBalancesDTO> postedBalances) {
