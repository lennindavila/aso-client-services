...
public class ResponseHeader  implements java.io.Serializable {
    ...
    /**
     * Gets the idTransaccion value for this ResponseHeader.
     * 
    ...
    /**
     * Sets the idTransaccion value for this ResponseHeader.
     * 
     * @param idTransaccion
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://pe.grupobbva.com/SIR/ents/header", "ResponseHeader"));
