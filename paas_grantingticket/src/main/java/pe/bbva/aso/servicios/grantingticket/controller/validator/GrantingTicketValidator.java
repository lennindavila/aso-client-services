package pe.bbva.aso.servicios.grantingticket.controller.validator;
...
@Component
@Scope("prototype")
public class GrantingTicketValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		RequestGrantingTicket request = (RequestGrantingTicket) target;
