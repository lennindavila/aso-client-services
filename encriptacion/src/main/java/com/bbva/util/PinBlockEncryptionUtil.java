...
public class PinBlockEncryptionUtil {
	...
	public static void main(String[] args) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
		...
		System.out.println(encryptPinBlock("1234567890123456", "1234", key, 168));

	}

	/**
	 * Encrypts the security pin for a card and gives the Hex representation of the
	 * encrypted pin block.
	 * 
	 ...
	 */
	public static String encryptPinBlock(String cardNumber, String pin, String key, int keySize)
	 ...
	 * First get the card padded (16 Char) which when converted to Hex gives an
	 * array of 8 Get the Pin Padded (16 Char) which when converted to Hex gives an
	 * array of 8 XOR the resulting arrays to get the pin block
	 * 
	 * @param cardNumber
	 * @param pin
	 * @return
	...
	/**
	 * Generates a 16 digit block, with following Components Two digit pin length
	 * (left padded with zero if length less than 10) Pin Number Right padded with F
	 * to make it 16 char long. FOr example for a 5 digit Pin 12345 the outout would
	 * be 0512 345F FFFF FFFF
	 * 
	 * @param pin
	 * @return
	 * @throws IllegalBlockSizeException
	...
	/**
	 * Using the Card Number it generates a 16-digit block with 4 zeroes and and the
	 * 12 right most digits of the card number, excluding the check digit (which is
	 * the last digit of the card number. For Example for a Card 5259 5134 8115 5074
	 * 4 Will be the check digit Right most 12 digits would be 951348115507 Hence
	 * the output would be 0000 9513 4811 5507
	 * 
	 * @param cardNumber
	 * @return
	 * @throws IllegalBlockSizeException
	 ...
	 *                  string are 16 (56 bit), 32 (112 bit), 32 or 48 (for 168
	 *                  bit). If the key Strength is 168 bit and the key length is
	 *                  32 the first 16 chars are repeated.
