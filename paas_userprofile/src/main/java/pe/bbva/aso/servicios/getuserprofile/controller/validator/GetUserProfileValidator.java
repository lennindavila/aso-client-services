package pe.bbva.aso.servicios.getuserprofile.controller.validator;
...
@Component
@Scope("prototype")
public class GetUserProfileValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		RequestGetUserProfile request = (RequestGetUserProfile) target;
