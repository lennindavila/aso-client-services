package pe.bbva.aso.servicios.getfinancialdashboard.controller.validator;
...
@Component
@Scope("prototype")
public class GetFinancialDashboardValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		RequestGetFinancialDashboard request = (RequestGetFinancialDashboard) target;
